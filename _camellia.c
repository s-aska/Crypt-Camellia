 ...
 *						  *
 *  Slight modification by Julius C. Duque        *
 **************************************************/
...
int main(void)
{
    ...
    static unsigned char plaintext1[16] = {
        0x01,0x23,0x45,0x67,0x89,0xab,0xcd,0xef,
        0xfe,0xdc,0xba,0x98,0x76,0x54,0x32,0x10
    };

    Byte expkey[256];
    static unsigned char plaintext2[16];
    static unsigned char ciphertext[16];

    Camellia_Ekeygen(128, key, expkey);
    Camellia_Encrypt(128, plaintext1, expkey, ciphertext);
    Camellia_Decrypt(128, ciphertext, expkey, plaintext2);
